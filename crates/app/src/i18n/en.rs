...
pub(super) const STRINGS: Strings = Strings {
    ...
    watch_enabled_hint: "Monitors game manifests for launcher updates and re-scans or trims automatically.",
    ...
    watch_mode_interactive_hint: "Shows a Windows Toast notification with a button to trim re-downloaded files.",
    ...
    watch_mode_passive_hint: "Updates status badges in GameTrimmer without automatic deletion or toasts.",
